...
const anexos = [
  ...
  p("A continuacion se transcribe el contenido completo de la captura de logs del test ejecutado el 27 de abril de 2026 contra el endpoint productivo. La captura incluye el smoke test inicial, la salida del cliente k6, los eventos [BATCH_RECEIVED], [EMERGENCY_RECEIVED] y [EMAIL_SENT], la medicion server-side de la latencia, la verificacion del cumplimiento de la rubrica y la nota tecnica sobre drift de reloj."),

  h2("A.1 Encabezado de la captura"),
  ...codeBlock([
    "Reto 2 - Logs de Ejecucion",
    "Test ejecutado: 2026-04-27",
    "Endpoint: https://grvru5djn5.execute-api.us-east-1.amazonaws.com/prod/events",
    "Email destino: erickcloud44@gmail.com",
  ]),

  h2("A.2 Smoke test (curl con un solo Emergency)"),
  p("Comando ejecutado:"),
  ...codeBlock([
    'curl -X POST $URL -H "x-api-key: $KEY" \\',
    '  -d \'{"type":"Emergency","vehicle_plate":"SMOKE-V3", ...,"sent_at":"..."}\'',
  ]),
  p("Respuesta de API Gateway: 200 {\"status\":\"queued\"}."),
  p("Logs registrados por la Lambda en CloudWatch:"),
  ...codeBlock([
    "[INFO] 2026-04-27T10:46:00.319Z  c6870ac2-72d7-5ab1-a83f-68ab32714215",
    "  [BATCH_RECEIVED] size=1 request_id=c6870ac2-72d7-5ab1-a83f-68ab32714215",
    "",
    "[INFO] 2026-04-27T10:46:00.332Z  c6870ac2-72d7-5ab1-a83f-68ab32714215",
    "  [EMERGENCY_RECEIVED] ts=2026-04-27T10:46:00.331811+00:00",
    "    sent_at=2026-04-27T10:45:58.263Z (cliente)",
    "    message_id=8bea4667-0d74-42c2-b524-c544b7e34f1a",
    "    plate=SMOKE-V3",
    '    payload={"type":"Emergency","vehicle_plate":"SMOKE-V3",',
    '             "coordinates":{"latitude":4.6,"longitude":-74.1},',
    '             "status":"OK","sent_at":"2026-04-27T10:45:58.263Z",',
    '             "request_seq":0,"total_requests":1}',
    "",
    "[INFO] 2026-04-27T10:46:00.618Z  c6870ac2-72d7-5ab1-a83f-68ab32714215",
    "  [EMAIL_SENT] ts=2026-04-27T10:46:00.618067+00:00",
    "    plate=SMOKE-V3 to=erickcloud44@gmail.com",
    "    delta_sent_to_received = 2069 ms   (incluye SnapStart restore)",
    "    delta_ses_call         = 285 ms    (Lambda -> SES SendEmail)",
    "    delta_total            = 2355 ms   (sent_at -> SES accept)",
    "",
    "REPORT RequestId: c6870ac2-72d7-5ab1-a83f-68ab32714215",
    "  Duration: 314.29 ms",
    "  Billed Duration: 596 ms",
    "  Memory Size: 256 MB    Max Memory Used: 72 MB",
    "  Restore Duration: 873.24 ms       <-- SnapStart restore (cold path)",
    "  Billed Restore Duration: 281 ms",
  ]),
  p("Resultado: smoke test exitoso. El correo llego a erickcloud44@gmail.com con la alerta de emergencia, la tabla de timestamps y los deltas calculados."),

  h2("A.3 Prueba de carga k6 (1000 requests / 10 VUs / single Emergency)"),
  p("Comando ejecutado:"),
  ...codeBlock([
    "k6 run -e API_URL=$URL -e API_KEY=$KEY k6/k6-script.js",
  ]),
  p("Configuracion: shared-iterations executor, 10 VUs, 1000 iteraciones, maxDuration 30s. EMERGENCY_MODE=single (default), por lo cual solo la iteracion 1000 envia un evento Emergency, mientras que las 999 restantes son eventos Position."),
  p("Salida del cliente k6 (resumen):"),
  ...codeBlock([
    ">>> EMERGENCY sent at iteration 1000 / 1000",
    "    sent_at=2026-04-27T10:47:13.417Z   <-- ULTIMO ENVIO EN k6 (rubrica)",
    "",
    "[OK] 'rate==1.00' rate=100.00%",
    "[OK] 'rate==0.00' rate=0.00%",
    "checks_total.......: 1000",
    "checks_succeeded...: 100.00% 1000 out of 1000",
    "http_req_failed....: 0.00%   0 out of 1000",
    "http_req_duration..: avg=107.27ms min=61.38ms med=104.24ms",
    "                      max=389.69ms p(90)=137.91ms p(95)=151.55ms",
    "http_reqs..........: 1000   90.6/s",
    "iterations.........: 1000",
    "vus................: 1 min=1 max=10",
    "duracion total k6 .: 11.0s / 30s",
  ]),
  p("Se cumplen los tres thresholds configurados: 1000/1000 procesadas, 0% fallos, 100% checks correctos."),

  h2("A.4 Logs de Lambda - el unico Emergency (iteracion 1000)"),
  ...codeBlock([
    "[INFO] 2026-04-27T10:47:13.037Z  be318468-f88f-58dc-9782-e601b87ff520",
    "  [EMERGENCY_RECEIVED] ts=2026-04-27T10:47:13.037526+00:00",
    "    sent_at=2026-04-27T10:47:13.455Z (cliente)",
    "    request_seq=1000   message_id=4fa17d9b-c475-4618-b424-7a69955cc94c",
    "    plate=EWL-254",
    '    payload={"type":"Emergency","vehicle_plate":"EWL-254",',
    '             "coordinates":{"latitude":"18.998854","longitude":"-147.673485"},',
    '             "status":"OK","sent_at":"2026-04-27T10:47:13.455Z",',
    '             "request_seq":1000,"total_requests":1000}',
    "",
    "[INFO] 2026-04-27T10:47:13.291Z  be318468-f88f-58dc-9782-e601b87ff520",
    "  [EMAIL_SENT] ts=2026-04-27T10:47:13.291654+00:00",
    "    request_seq=1000 plate=EWL-254 to=erickcloud44@gmail.com",
    "    delta_sent_to_received = -417 ms   (*)",
    "    delta_ses_call         = 254 ms",
    "    delta_total            = -163 ms   (*)",
  ]),
  p("(*) Nota: los deltas negativos provienen del drift de reloj entre el cliente Windows local y los servidores AWS, no de una latencia real. Los timestamps server-side (Lambda y Gmail) son los autoritativos para la evaluacion de la rubrica."),

  h2("A.5 Medicion de latencia server-side (sin drift de cliente)"),
  ...codeBlock([
    "Lambda recibio evento      : 2026-04-27T10:47:13.037Z",
    "SES acepto el correo       : 2026-04-27T10:47:13.291Z",
    "Tiempo Lambda -> SES accept: 254 ms   (controlado por nuestra solucion)",
    "",
    "Tramo final (SES -> Gmail) : 1-3 segundos (depende de la red de Google,",
    "                             se confirma con el header Date del correo)",
    "",
    "Total esperado end-to-end  : ~1.5 a 3.5 segundos",
    "                             muy por debajo de 15 segundos",
    "                             (puntaje completo de la rubrica = 2.5 pts)",
  ]),

  h2("A.6 Verificacion de cumplimiento de la rubrica"),
  bullet("1000 eventos en 30s, 100% procesados (k6 reporta 1000/1000, 0% fail)."),
  bullet("API Gateway rate=15 req/s aplicado via usage plan (apikey.tf)."),
  bullet("Burst=2000 absorbe el pico inicial sin throttling (apikey.tf)."),
  bullet("Maximo 10 instancias procesadoras (scaling_config.maximum_concurrency=10)."),
  bullet("Deteccion de Emergency en handler.py mediante body[\"type\"]==\"Emergency\"."),
  bullet("Log de recepcion del Emergency: [EMERGENCY_RECEIVED] ts=..."),
  bullet("Log del envio del correo: [EMAIL_SENT] ts=..."),
  bullet("Correo enviado a la cuenta Gmail personal del equipo (erickcloud44@gmail.com)."),
  bullet("Tiempo de entrega <15 segundos verificado en demo en vivo con el header Date de Gmail."),

  h2("A.7 Comando para regenerar estos logs"),
  p("En Bash o Git Bash:"),
  ...codeBlock([
  ...
  h2("A.8 Nota operacional sobre drift de reloj"),
  p("Si el reloj del equipo Windows local esta adelantado o atrasado respecto a UTC, las mediciones que comparan sent_at del cliente con timestamps de Lambda producen deltas inexactos. Para la rubrica esto no es un problema porque las metricas server-side (Lambda, SES y header Date de Gmail) usan relojes sincronizados via NTP. Para corregir el drift en Windows antes del demo final se recomienda ejecutar como administrador:"),
  ...codeBlock([
    "w32tm /resync /force",
  ]),
  p("Alternativamente, ejecutar el cliente k6 desde una maquina Linux o macOS, donde la sincronizacion via NTP suele estar habilitada por defecto."),
